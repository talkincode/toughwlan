...
#coding=utf-8
import copy
from toughportal.console.libs.pyforms import  attrget
from toughportal.console.libs.pyforms import storage
from toughportal.console.libs.pyforms import AttributeList
