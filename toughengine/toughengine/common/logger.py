...
FORMATTER = logging.Formatter(u'%(asctime)s {0} %(name)s %(levelname)-8s %(module)s %(message)s'.format(socket.gethostname()), '%b %d %H:%M:%S', )
...
class Logger:
    ...
    def __init__(self,config):
        ...
        self.syslogger = logging.getLogger('toughengine')
