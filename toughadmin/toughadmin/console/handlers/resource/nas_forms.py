...
bas_add_form = pyforms.Form(
    ...
    pyforms.Dropdown("portal_vendor", description=u"portal类型", args=portaltype.items(), required="required", **input_style),
    pyforms.Dropdown("time_type", description=u"时间类型", args=timetype.items(), required="required", **input_style),
    pyforms.Textbox("ac_port", rules.is_number, description=u"AC端口", default=3799, required="required",**input_style),
