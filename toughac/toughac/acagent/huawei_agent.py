...
from toughac.portal import huawei,pktutils
...
class HuaweiAgent(protocol.DatagramProtocol):
    ...
    def doAckLogout(self, req):
        ...
        resp2 = huawei.Portal.newMessage(
    ...
    def datagramReceived(self, datagram, (host, port)):
        try:
            ...
            _packet = huawei.Portal(secret=self.config.ac.key, packet=datagram, source=(host, port))
    ...
    def run_normal(self):
        self.syslog.info('running huawei acagent server')
