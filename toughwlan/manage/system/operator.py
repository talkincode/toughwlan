...
class UpdateHandler(BaseHandler):
    ...
    def get(self):
        ...
        form.fill(self.db.query(models.TrwOperator).get(operator_id))
        form.operator_pass.set_value('')
        rules = self.db.query(models.TrwOperatorRule.rule_path).filter_by(operator_name=opr.operator_name)
